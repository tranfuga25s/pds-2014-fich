...
% 
%Obtenemos orden y frecuencia para filtro pasabanda el�ptico
[Nelip,Wnelip]=ellipord([2500/5000 3000/5000],[2300/5000 3200/5000],0.7,55) 
%partir de estos datos generamos el filtro el�ptico
[Belip ,Aelip] = ellip(Nelip, 0.7, 55, Wnelip);
figure('name','Ejercicio 3 - eliptico');
plot(abs(freqz(Belip,Aelip,5000)));title('el�ptico')



%Vemos que el orden m�nimo es el del filtro el�ptico con un valor 5.
